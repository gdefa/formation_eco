 ...
 */
final class Version20220411133712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE progress DROP section_finished');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE progress ADD section_finished TINYINT(1) NOT NULL');
